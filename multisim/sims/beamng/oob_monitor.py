...
class OutOfBoundsMonitor:
    ...
    def get_oob_info(self, wrt="right", oob_bb=True) -> Tuple[bool, int, float]:
        # HACK We dont use oob in multisim (VIA XTE decided on high level)
        ...
        # HACK There is an error for some roads; we dont use it anyway in msim
        # shapely.geos - ERROR - TopologyException: Input geom 1 is invalid: Self-intersection at -3.7565305331707366 -65.42538622258742
        # shapely.geos - INFO - Self-intersection at or near point -3.7565305331707366 -65.42538622258742
