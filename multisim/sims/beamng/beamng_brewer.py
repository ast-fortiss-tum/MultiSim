...
from sims.beamng.config import BASE_PORT, BEAMNG_VERSION
from sims.beamng.decal_road import DecalRoad
from sims.beamng.simulation_data import SimulationParams
...
class BeamNGBrewer:
    def __init__(
        ...
        if self.reuse_beamng:
            ...
            print("[BeamNG Brewer] in reuse_beamng")
        ...
        print(f"[BeamNGBrewer] init completed.")
    ...
    def bring_up(self):
        try:
            ...
            print(e)
            print(f"[Brewer] Exception caught.")
            raise e
        ...
        if self.camera:
            ...
            log.info("[BeamNGBrewer] camera added")
