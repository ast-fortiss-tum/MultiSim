...
FILTER_ROADS = False
METRIC = None # pointwise, euclid or None
...
def get_valid_over_time(paths,
    ...
    save_folder_efficiency = f"{save_folder_all}/efficiency_det/{date}/"
    ...
    for j, folder_path in enumerate(paths):
        ...
        for i in selector:
            ...
            def get_valid_in_buckets(path_all_tests, 
                ...
                P = read_pf_single(path_all_tests).get("X")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_runs', type=int, required=True, 
                        help='Number of runs')
    parser.add_argument('--parent_folder', type=str, default="myfolder",
                        help='Immediate results folder.')
    # Parse arguments from the command line
    args = parser.parse_args()
    
    # Call the function with parsed arguments
    get_valid_over_time(args.paths, 
