...
save_folders=( ./results/VARSEG_Mock_A10_-180-180_XTE_DIST_gen5_pop5_seed1/NSGAII-D/temp
)
...
do
    python -m scripts_analysis.validation --n_repeat_validation "${n_repeat_validation}" \
                    ...
                    --folder_name_combined_prefix "validation_qu_all_" \
                    --folder_validation_prefix "validation_qu_all_" \
                    --simulators "mock" \
                    --from_part_fmap 4
done
