...
BASE_DIR="../msim-results/analysis/analysis_5-runs_08-09-2024_19-42-35_20-gen_20-pop"
...
for ((run=0; run<5; run++)); do
    ...
    PROBLEM_PATHS=(
        "$BASE_DIR/run_${run}/${SIM_PATH}/VARSEG_MOO_A10_-180-180_XTE_DIST_BOTH_gen20_pop20_seed${SEED}/NSGAII-D/myfolder/backup/problem"
        # "$BASE_DIR/run_${run}/${SIM_PATH}/VARSEG_${SIM}_A10_-180-180_XTE_DIST_gen20_pop20_seed${SEED}/NSGAII-D/myfolder/backup/problem"
    )

    PARENT_FOLDERS=(
        "$BASE_DIR/run_${run}/${SIM_PATH}/VARSEG_MOO_A10_-180-180_XTE_DIST_BOTH_gen20_pop20_seed${SEED}/NSGAII-D/myfolder/"
        # "$BASE_DIR/run_${run}/${SIM_PATH}/VARSEG_${SIM}_A10_-180-180_XTE_DIST_gen20_pop20_seed${SEED}/NSGAII-D/myfolder/backup/resumed/"
    )
