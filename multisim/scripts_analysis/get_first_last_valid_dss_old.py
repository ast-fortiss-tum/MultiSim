...
# the single run folder for the "second dss approach"
paths_second_dss= [
    r"C:\Users\levia\Documents\testing\Multi-Simulation\msim-results\analysis\analysis_5-runs_08-09-2024_19-42-35_20-gen_20-pop\\",# beamng
    r"C:\Users\levia\Documents\testing\Multi-Simulation\msim-results\analysis\analysis_5-runs_08-09-2024_19-42-35_20-gen_20-pop\\", # udacity
    r"C:\Users\levia\Documents\testing\Multi-Simulation\msim-results\analysis\analysis_5-runs_08-09-2024_19-42-35_20-gen_20-pop\\" # donkey
]

paths = [
    r"C:\Users\levia\Documents\testing\Multi-Simulation\msim-results\analysis\analysis_5-runs_17-09-2024_DB\\",
    r"C:\Users\levia\Documents\testing\Multi-Simulation\msim-results\analysis\analysis_5-runs_17-09-2024_DB\\",
    r"C:\Users\levia\Documents\testing\Multi-Simulation\msim-results\analysis\analysis_5-runs_08-09-2024_19-42-35_20-gen_20-pop\\"
    ]



validation_folders = [
    "validation_all_qu_dsim_combined_count-3.0_bd_u",
    "validation_all_qu_dsim_combined_count-3.0_bu_d",
    "validation_all_qu_dsim_combined_count-3.0_du_b"
]
...
save_folder_all =  r"..\msim-results\analysis\analysis_5-runs_dss_all_10-12-2024\\"
...
for j, folder_path in enumerate(paths):
    ...
    for i in range(0,n_runs):
        ...
        path_second_dss = os.path.join(paths_second_dss[j],f"run_{i}/{sim_map_second_dss[j]}")
