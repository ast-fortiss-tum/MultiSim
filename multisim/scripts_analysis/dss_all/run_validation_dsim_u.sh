# Base directory
base_dir="../msim-results/analysis/analysis_runs_01-01-2025_U/"
...
seeds=(760 348 859 29 120 702 794 655 904 684)  # Corresponding seeds for each run
